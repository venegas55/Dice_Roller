...
class MainActivity : AppCompatActivity() {
    ...
    /**
     * This functions iterates class Dice into an object dice
     * with parameter of 6 and updates TextView with the result
     * NEW** Now it iterates 6 dice images and updates the
     * result with a dice image
     */
